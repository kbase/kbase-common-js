...
define([
    ...
    // copied from narrative display.js
    ...
    DynamicTable.prototype.makeWidgetFooter = function () {
        ...
        if (this.options.enableDownload) {
            ...
            var $dlBtn = simpleButton('btn-md btn-default dropdown-toggle', 'fa fa-download')
                .click(function () {
                    saveAs(new Blob(csvRows(self.currentData)), self.options.downloadFileName);
                });
            var $dlAllBtn = simpleButton('btn-md btn-default dropdown-toggle', 'fa fa-cloud-download')
                .click(function () {
